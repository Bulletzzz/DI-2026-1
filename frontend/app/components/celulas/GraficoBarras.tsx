      ...
      {dados.map(({ rotulo, valor }) => {
        ...
        return (
          <div key={rotulo} className="flex flex-col items-center gap-2 flex-1 group">
            <span className="text-[10px] text-[#f97316] opacity-0 group-hover:opacity-100 print:opacity-100 transition-opacity whitespace-nowrap">
              {formatar(valor)}
            </span>
            <div
              className="w-full bg-[#f97316]/30 group-hover:bg-[#f97316]/60 print:bg-[#f97316] transition-colors duration-200"
